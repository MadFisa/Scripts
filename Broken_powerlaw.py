...
##################################################################################
# F_f=F_arb(nu,nu_b,F_0,beta1,beta2,s)
nu_obs=1e21
F_f1=F_arb([nu_obs],nu_b,F_0,beta1,beta2,s)  
...
# F_f2=F_arb(nu,[nu_b_obs],0.06,beta1,beta2,s).T  
...
F=F_arb(freqs_m,nu_b,F_0,beta1,beta2,s)
