...
yourself. The files all begin spec0 - which is the internal name given to this
spectum. The files spec0pc.pi and/or spec0wt.pi are those which were
...
If you use the spec0[wt|pc].pi files, Xspec will look for the back.pi and
