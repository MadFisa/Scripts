...
yourself. The files all begin spec5 - which is the internal name given to this
spectum. The files spec5pc.pi and/or spec5wt.pi are those which were
...
If you use the spec5[wt|pc].pi files, Xspec will look for the back.pi and
