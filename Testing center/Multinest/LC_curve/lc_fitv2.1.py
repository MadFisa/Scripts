...
def prior(cube):
    ...
    cube[1] = cube[1]*-10         #beta2 = uniform prior between 0:-10
    cube[2] = cube[2]*-10           #P_F  =uniform prior between 0:-10
    cube[3] = cube[3]*-10           #P_b = uniform prior between 0:-10
    cube[4] = 10**(cube[4]*20 - 5) # F_0 = log-uniform prior between 10^-5 and 10^5
    cube[5] = 10**(cube[5]*20 + 20) # nu_b0=log-uniform prior between 10^10 and 10^30
    # if ndim < 7:
    #     return
