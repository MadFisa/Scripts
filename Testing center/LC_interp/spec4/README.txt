...
yourself. The files all begin spec4 - which is the internal name given to this
spectum. The files spec4pc.pi and/or spec4wt.pi are those which were
...
If you use the spec4[wt|pc].pi files, Xspec will look for the back.pi and
