...
yourself. The files all begin spec1 - which is the internal name given to this
spectum. The files spec1pc.pi and/or spec1wt.pi are those which were
...
If you use the spec1[wt|pc].pi files, Xspec will look for the back.pi and
