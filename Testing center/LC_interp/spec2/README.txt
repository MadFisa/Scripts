...
yourself. The files all begin spec2 - which is the internal name given to this
spectum. The files spec2pc.pi and/or spec2wt.pi are those which were
...
If you use the spec2[wt|pc].pi files, Xspec will look for the back.pi and
