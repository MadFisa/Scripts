...
yourself. The files all begin spec6 - which is the internal name given to this
spectum. The files spec6pc.pi and/or spec6wt.pi are those which were
...
If you use the spec6[wt|pc].pi files, Xspec will look for the back.pi and
