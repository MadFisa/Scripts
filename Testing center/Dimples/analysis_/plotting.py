...
if len(t_uvot_uvw2)!=0 or len(t_uvot_uvw2_ul)!=0:
    for i in range(nlines):
        n=int(np.random.uniform(1,tot-burn))
        parmlist=(smpl0[n+burn],smpl1[n+burn],smpl2[n+burn],smpl3[n+burn],smpl4[n+burn],smpl5[n+burn])
...
if len(t_uvot_uvm2)!=0 or len(t_uvot_uvm2_ul)!=0:
    for i in range(nlines):
        n=int(np.random.uniform(1,tot-burn))
        parmlist=(smpl0[n+burn],smpl1[n+burn],smpl2[n+burn],smpl3[n+burn],smpl4[n+burn],smpl5[n+burn])
...
if len(t_uvot_white)!=0 or len(t_uvot_white_ul)!=0:
    for i in range(nlines):
        n=int(np.random.uniform(1,tot-burn))
        parmlist=(smpl0[n+burn],smpl1[n+burn],smpl2[n+burn],smpl3[n+burn],smpl4[n+burn],smpl5[n+burn])
...
if len(t_uvot_u)!=0 or len(t_uvot_u_ul)!=0:
    for i in range(nlines):
        n=int(np.random.uniform(1,tot-burn))
        parmlist=(smpl0[n+burn],smpl1[n+burn],smpl2[n+burn],smpl3[n+burn],smpl4[n+burn],smpl5[n+burn])
...
if len(t_uvot_v)!=0 or len(t_uvot_v_ul)!=0:
    for i in range(nlines):
        n=int(np.random.uniform(1,tot-burn))
        parmlist=(smpl0[n+burn],smpl1[n+burn],smpl2[n+burn],smpl3[n+burn],smpl4[n+burn],smpl5[n+burn])
...
if len(t_uvot_b)!=0 or len(t_uvot_b_ul)!=0:
    for i in range(nlines):
        n=int(np.random.uniform(1,tot-burn))
        parmlist=(smpl0[n+burn],smpl1[n+burn],smpl2[n+burn],smpl3[n+burn],smpl4[n+burn],smpl5[n+burn])
