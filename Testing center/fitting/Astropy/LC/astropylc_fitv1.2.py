...
# def model_f1(t,F_0,nu_b0,alpha_1,alpha_2):
...
#     F= f_nu(t,nu,F_0,0,nu_b0,0,alpha_1,alpha_2,delta_t)
#     return F[:,0]
...
# LB=[0,0,0,0] #Lower bound for parameters
# UB=[np.inf,np.inf,10,10] #Upperbound for parameters
