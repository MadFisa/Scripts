...
LB=[-20,0,0,0,0,0] #Lower bound for parameters
...
# popt, pcov = curve_fit(model_f, np.log10(t_data), np.log10(lc_data),bounds=(LB,UB),method='trf')
...
plt.scatter(np.log10(t_data),np.log10(lc_data),label="data")
