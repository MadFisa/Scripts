...
def prior(cube):
    """Priors for parameters are F_0,E_52 and possibly """
    cube[0] =10**(-cube[0]*20 + 5)      #beta1 =uniform prior between 0:-10
    cube[1] = 10**(cube[1]*5 - 5)          #beta2 = uniform prior between 0:-10
