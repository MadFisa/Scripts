...
t=np.logspace(-3,5,1000)#Defines time
freqs=np.logspace(1,35,100000)#Defines frequencies
...
window_f1=75000 #Window frequency 1 index
window_f2=85000 #Window frequency 2 index
...
# model_x=freqs[window_f1:window_f2]
# model_y=F2[ti,window_f1:window_f2]

# popt,pcov=powerFit(model_x,model_y,p=-1,a=1.)
# fit=powerLaw(model_x,*popt)

# plt.loglog(freqs,F2[ti,:],label='smoothie')
# plt.loglog(model_x,fit,label='fit')
# plt.loglog(model_x,model_y,label='model')
# plt.legend()
