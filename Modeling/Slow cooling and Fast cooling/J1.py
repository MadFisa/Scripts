...
def calc_flux_sharpo(t,freqs,F_0):
    ...
    F_slow=np.array(SlowCooling(freqs[mask_slow],freq_c[mask_slow],freq_m[mask_slow],F_0))
    F_fast=np.array(FastCooling(freqs[mask_Fast],freq_c[mask_Fast],freq_m[mask_Fast],F_0))
...
t=np.logspace(1,5,4000)#Defines time
